...
@section('title', '未缴费罚款')
@section('css')
    <link rel="stylesheet" href="{{ asset('/css/punish/uncharged.css') }}"/>
@endsection
@section('header')
    ...
    <nav class="navbar navbar-default navbar-small">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                <form class="navbar-form navbar-left" role="search"  method="get" action="{{ url('punish/uncharged-list') }}">
        ...
        <table class="table table-bordered table-hover table-condensed">
            ...
            @foreach ($unchargedLists as $unchargedList)
                <tr>
                    ...
                    <td>{{ $unchargedList->user->user_name }}</td>
...
@endsection
@section('bottom')
    <p>当前共有 {{ $unchargedLists->total() }} 条记录</p>
